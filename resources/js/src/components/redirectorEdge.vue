...
<template>
	<svg class="container-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" :fill="localStates.color">
		...
		>
			<div style="position: absolute; top: 50%; left: 50%; font-size: 5px; transform: translate(-50%, -50%)">
				<!-- Delete Button and color controls Menu -->
				<topMenu :eid="props.id" :transparent="transparent" style="position: absolute; transform: translate(-54%, -25%)"> </topMenu>
				<!-- Delete Button and color controls Menu -->
			</div>
