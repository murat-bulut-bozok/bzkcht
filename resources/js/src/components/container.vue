...
<template>
	<div :id="id" style="position: relative; border-radius: 1rem; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px" @mouseenter="transparent = false" @mouseleave="transparent = true">
		<div class="label">
		...
		<Handle :id="id + 'left'" class="handle" type="target" :position="Position.Left" style="top: 50%; left: -1.5%" />
		<Handle :id="id + 'right'" class="handle" type="source" :position="Position.Right" style="top: 50%; right: -1.5%" />
		<Handle :id="id + 'bottom'" class="handle" type="source" :position="Position.Bottom" style="top: 100.5%" />
	</div>
</template>
