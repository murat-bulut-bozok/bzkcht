...
@section('title', __('edit_highlighted_feature'))
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    <h3 class="section-title">{{ __('edit_highlighted_feature') }}</h3>
                    <div class="default-tab-list default-tab-list-v2  bg-white redious-border p-20 p-sm-30">
                        <div class="row">
                            <form action="{{ route('highlighted-feature.update', $feature->id) }}" method="POST" class="form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row gx-20 add-coupon">
                                    ...
                                    <div class="col-lg-12 input_file_div mb-4">
                                        ...
                                        <div class="selected-files d-flex flex-wrap gap-20">
                                            <div class="selected-files-item">
                                                <img class="selected-img" src="{{ getFileLink('original_image', $feature->logo) }}"
                                                     alt="favicon">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control rounded-2 ai_content_name" id="mini_title" name="mini_title" value="{{ @$feature->mini_title }}">
                                            <div class="nk-block-des text-danger">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control rounded-2 ai_content_name" id="lable" name="lable" value="{{ @$feature->lable }}">
                                            <div class="nk-block-des text-danger">
