...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        foreach ($primaryUsers as $user) {
            $permissions = ['manage_whatsapp', 'manage_telegram', 'manage_messenger', 'manage_ai_writer', 'manage_team', 'manage_chat', 'manage_campaigns', 'manage_ticket', 'manage_setting','manage_widget','manage_template','manage_flow','manage_sms_marketing'];
