...
use App\DataTables\Client\Web\QuickReplyDataTable;
use App\Http\Requests\Client\BotReplyRequest;
use App\Http\Resources\CannedResponseResource;
use App\Repositories\Client\Web\QuickReplyRepository;
...
class QuickReplyController extends Controller
{
    ...
    public function __construct(QuickReplyRepository $replyRepo)
    {
        $this->replyRepo = $replyRepo;
    }

    public function index(QuickReplyDataTable $replyDataTable)
    {
        return $replyDataTable->render('backend.client.web.quick_reply.index');
    }

    public function create()
    {
        return view('backend.client.web.quick_reply.create');
    }
    ...
    public function store(BotReplyRequest $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'route'   => route('client.web.whatsapp.quick-reply.index'),
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
            if (config('app.debug')) {
    ...
    public function edit($id)
    {
        ...
        return view('backend.client.web.quick_reply.edit', compact('reply'));
    }
